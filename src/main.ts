...
if (typeof apiDato === "string") {
  console.log(apiDato.toUpperCase());
} else if (typeof apiDato === "number") {
  console.log(apiDato * 2);
} else if (typeof apiDato === "boolean") {
  console.log(apiDato ? "Sì" : "No");
} else if (apiDato === null) {
  console.log("Il dato è vuoto");
} else if (Array.isArray(apiDato)) {
  console.log(apiDato.length);
} else if (apiDato instanceof Promise) {
  apiDato.then((value) => console.log(value));
} else {
